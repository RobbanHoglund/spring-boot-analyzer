...
public class GradleFailureClassifier {
    ...
    public GradleFailureClassifier(
            GradlePluginResolutionFailureParser pluginResolutionFailureParser) {
    ...
    public ClassifiedGradleFailure classify(
        ...
        if (normalized.contains("timed out")) {
            return new ClassifiedGradleFailure(
                    GradleExecutionFailureType.TIMED_OUT, pluginResolutionFailure);
        }
        if (normalized.contains("could not compile initialization script")
            ...
            return new ClassifiedGradleFailure(
                    GradleExecutionFailureType.INIT_SCRIPT_COMPILATION_FAILED, null);
        }
        ...
        if (normalized.contains("could not resolve all files for configuration")
            ...
            return new ClassifiedGradleFailure(
                    GradleExecutionFailureType.DEPENDENCY_RESOLUTION_FAILED, null);
        }
        if (normalized.contains("tooling api")
            ...
            return new ClassifiedGradleFailure(
                    GradleExecutionFailureType.TOOLING_API_TRANSPORT_FAILED, null);
        }
