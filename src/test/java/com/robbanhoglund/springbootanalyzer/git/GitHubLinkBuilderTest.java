    ...
    void buildsBlobUrlForHttpsRepositoryWithGitSuffix() {
        assertThat(
                        builder.buildBlobUrl(
                                ...
                                12))
                .isEqualTo(
                        "https://github.com/owner/repo/blob/abc123/src/main/java/com/example/Demo.java#L10-L12");
    }
    ...
    void buildsBlobUrlForHttpsRepositoryWithoutGitSuffix() {
        assertThat(
                        builder.buildBlobUrl(
                                ...
                                10))
                .isEqualTo(
                        "https://github.com/owner/repo/blob/abc123/src/main/java/com/example/Demo.java#L10");
    }
