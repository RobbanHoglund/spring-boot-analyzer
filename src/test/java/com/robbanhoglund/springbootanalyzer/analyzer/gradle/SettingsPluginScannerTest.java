...
class SettingsPluginScannerTest {
    ...
    void extractsGroovySettingsPlugins() throws Exception {
        ...
        assertThat(plugins)
                .extracting("pluginId")
                .containsExactly(
                        "org.gradle.toolchains.foojay-resolver-convention", "com.example.demo");
    }
    ...
    void extractsKotlinSettingsPlugins() throws Exception {
        ...
        assertThat(plugins.getFirst().pluginId())
                .isEqualTo("org.gradle.toolchains.foojay-resolver-convention");
