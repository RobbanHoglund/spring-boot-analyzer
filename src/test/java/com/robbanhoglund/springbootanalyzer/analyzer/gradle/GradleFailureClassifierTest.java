...
class GradleFailureClassifierTest {
    ...
    void classifiesInitScriptCompilationFailure() {
        ...
        var classified =
                classifier.classify(message, "9.5.0", 25, new GradleJavaCompatibilityService());

        assertThat(classified.failureType())
                .isEqualTo(GradleExecutionFailureType.INIT_SCRIPT_COMPILATION_FAILED);
    }
}
